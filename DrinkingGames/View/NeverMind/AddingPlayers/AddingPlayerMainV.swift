...
struct AddingPlayerMainV: View {
    ...
    private var startButton: some View {
        Group{
            ...
            NavigationLink(destination: ModeSelectionMainV(acColor: $acColor), isActive: $pushNavigation) {
                Text("")
            }.hidden()
        }
    }
...
struct MainIntialView_Previews: PreviewProvider {
    static var previews: some View {
        AddingPlayerMainV(acColor: .constant(.pink))
    }
}
